        ...
        <ul class="sidebar-menu tree" data-widget="tree">
            ...
            <li class="active treeview menu-open">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="active"><a href="{{ route('users.create') }}"> <i class="fa fa-user"> </i> Add User </a></li>
                    <li><a href="{{ route('roles.create')}}"><i class="fa fa-lock"></i> Select User Role </a></li>
            ...
            <ul class="sidebar-menu2">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ route('permissions.create')}}"><i class="fa fa-user"></i> Add Permission </a>
                        </li>
                        <li><a href="{{ route('permissions.index')}}"><i class="fa fa-user"></i> Manage Permission </a>
                        </li>
